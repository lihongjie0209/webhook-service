module github.com/lihongjie0209/webhook-service
...
require (
	...
	github.com/lihongjie0209/microservice-platform-go v0.9.5
	github.com/lihongjie0209/platform-protos v0.10.0
